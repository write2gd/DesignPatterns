...
/**
 * 
 * CustomerDaoImpl class violet the dependency injection principle and
...
public class CustomerDaoImpl implements CustomerDao {
	...
	private DataSourceService dataSource = new MySQLDataSource();

	private Connection getConnection() throws SQLException {
		return this.dataSource.getConnection();
	}

	private DataSourceService getDataSource() throws SQLException {
