 ...
 * It depends on abstraction(DataSourceService interface) that can be injected
 * through its constructor.
 * <p>
 * If we want to support Oracle database in future
 * then client needs to pass datasource implementation as per requirement.
 */
public class CustomerDaoImpl implements CustomerDao {

    private DataSource dataSource;

    //It depends on abstraction(DataSourceService interface) that can be injected through its constructor
